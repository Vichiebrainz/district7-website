  ...
  return (
    <>
      <div className="w-full flex flex-auto items center gap-8">
        <TabTitle title="Form" tab="form" onClick={() => setCurrentTab("form")} active={currentTab == "form"} />
        <TabTitle title="Posted apartments" tab="postedApartments" onClick={() => setCurrentTab("postedApartments")} active={currentTab == "postedApartments"} />
      </div>
      <TabList>
        {
          currentTab == "form" && 
